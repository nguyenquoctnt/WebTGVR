...
(function(window, document, $) {
	...
	$('.select-contact').selectize({
		...
		options: [
			{email: 'lio_40kesta.com', first_name: 'Lio', last_name: 'Kesta'},
			{email: 'brian_40carter.com', first_name: 'Brian', last_name: 'Carter'},
			{email: 'someone_40gmail.com'}
		],
		render: {
	...
	$('.selectize-links').selectize({
		...
		options: [
			...
			{id: 3, title: 'Yahoo', url: '../../../../../../yahoo.com'},
		],
		render: {
